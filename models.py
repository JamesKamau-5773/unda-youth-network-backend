...
# ============================================================================
# WORKSTREAMS MODELS - Programs, Pillars, Stories, Gallery
# ============================================================================

class Program(db.Model):
  """Programs/Workstreams for the UNDA Youth Network."""
  ...
  description = db.Column(db.Text)
  icon = db.Column(db.String(50))  # "MessageSquare", "Globe", "Users", etc.
  color = db.Column(db.String(20))  # "teal", "orange", "yellow", "navy"
  link = db.Column(db.String(100))
  cta = db.Column(db.String(50), default='Learn More')
  highlights = db.Column(db.JSON)  # Array of strings
...
class Pillar(db.Model):
  """Impact pillars for the UNDA Youth Network (Awareness, Access, Advocacy)."""
  __tablename__ = 'pillars'
  
  pillar_id = db.Column(db.Integer, primary_key=True)
  title = db.Column(db.String(50), nullable=False)  # "Awareness", "Access", "Advocacy"
...
class Story(db.Model):
  """Stories/Articles for the UNDA Youth Network workstreams."""
  ...
  category = db.Column(db.String(50))  # "impact", "news", "success-story", etc.
  tags = db.Column(db.JSON)
  featured = db.Column(db.Boolean, default=False)
  published = db.Column(db.Boolean, default=False)
  published_at = db.Column(db.DateTime)
...
class GalleryItem(db.Model):
  """Individual gallery items (photos/videos) for the UNDA Youth Network."""
  __tablename__ = 'gallery_items'
  
  item_id = db.Column(db.Integer, primary_key=True)
  type = db.Column(db.String(20), nullable=False)  # "photo", "video"
  title = db.Column(db.String(200), nullable=False)
  src = db.Column(db.String(500))  # For photos - image URL
  thumbnail = db.Column(db.String(500))  # For videos - thumbnail URL
  video_url = db.Column(db.String(500))  # For videos - video URL
  alt = db.Column(db.String(200))
  category = db.Column(db.String(50))  # "events", "podcast", "campaigns", etc.
  featured = db.Column(db.Boolean, default=False)
  published = db.Column(db.Boolean, default=True)
  order = db.Column(db.Integer, default=0)
  created_at = db.Column(db.DateTime, default=datetime.utcnow)
  ...
  def to_dict(self):
    ...
    if self.type == 'photo':
      ...
      base['thumbnail'] = self.thumbnail
      base['videoUrl'] = self.video_url
      base['video_url'] = self.video_url
    return base


class WorkstreamResource(db.Model):
  """Resources for workstreams (publications, toolkits, guides)."""
  __tablename__ = 'workstream_resources'
  
  resource_id = db.Column(db.Integer, primary_key=True)
  title = db.Column(db.String(200), nullable=False)
  description = db.Column(db.Text)
  category = db.Column(db.String(50))  # "publication", "toolkit"
  download_url = db.Column(db.String(500))
  thumbnail = db.Column(db.String(500))
  tags = db.Column(db.JSON)
  file_type = db.Column(db.String(20))  # "pdf", "doc", "link"
  file_size = db.Column(db.String(20))  # e.g., "2.5 MB"
  published = db.Column(db.Boolean, default=True)
  featured = db.Column(db.Boolean, default=False)
